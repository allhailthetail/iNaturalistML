...
** Ethics Concerns:
  ...
  - *Perhaps the model should have disclaimers anytime it's identifying anything from the fungi kingdom?*
    - Snakes, carnivores...
** Alternate Computer Vision Learning Methods
- Metadata (EXIF?)
- Histograms
- Image hashes
- Plants change appearance with the seasons.
  - Fall brown-trending
  - Spring green-trending
  - Birds blue/green (fliying or sitting in a tree?)
  - Aquatic blue/green (water/pond/river)

- incorporating GPS and other [[https://robots.net/tech/when-you-take-a-photo-using-your-smartphone-what-kind-of-data-is-the-photo/][metadata]] commonly found in smartphone photos, the ML algorithim could improve beyond visual cues only.
